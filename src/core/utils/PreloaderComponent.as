package core.utils{
	...
	public class PreloaderComponent extends Sprite{
		 ...
		 */
		public function PreloaderComponent($parent:DisplayObjectContainer, 
									  $x:int, 
									  $y:int, 
									  $radius:int = RADIUS,
		...
		private function getBar():Sprite	{
			...
			g.clear();
			g.beginFill(_colour);
			g.drawEllipse(_radius - _bar_length, -_bar_height*10, _bar_length, _bar_height);
